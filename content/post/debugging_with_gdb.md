...
Dump of assembler code for function main:
   0x0000555555554688 <+0>:     push   rbp		// Start of function prologue.
   0x0000555555554689 <+1>:     mov    rbp,rsp
   0x000055555555468c <+4>:     mov    ecx,0x62		// 'b'
   0x0000555555554691 <+9>:     mov    edx,0x61		// 'a'
   0x0000555555554696 <+14>:    mov    esi,0x2		// 2
   0x000055555555469b <+19>:    mov    edi,0x1		// 1
...
We can tell where the debugger halted in the function by the arrow in the first column.  It's currently sitting at line 5 in the `foo` function, and it's about to assign the value of 31337 to the `eleet` variable.  If we look inspect the memory that the variable is currently pointing to, we see it's just random noise:
...
[.gdbinit]: https://github.com/btoll/dotfiles/blob/master/gdb/.gdbinit
